    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Phrase Not Found</h1>
          <Link href="/phrasebook" className="text-blue-600 hover:text-blue-500">
            ← Back to Phrasebook
          </Link>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <span className="inline-block px-3 py-1 text-sm font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded capitalize">
                {item.partOfSpeech}
              </span>
            </div>
          ...
          <div className="space-y-6">
            ...
            {item.tts_url && (
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Pronunciation Audio</h3>
                <audio controls src={item.tts_url} className="mt-2 w-full" />
              </div>
            )}
          </div>
        </div>
