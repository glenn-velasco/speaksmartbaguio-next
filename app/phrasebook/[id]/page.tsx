    ...
    return (
      <Flex minHeight="100vh" align="center" justify="center">
        <Flex direction="column" align="center" gap="3">
          <Heading size="5" highContrast>Phrase Not Found</Heading>
        ...
        <Card size="4">
          <Flex justify="between" align="start" mb="5">
            <Box>
              ...
              <Badge color="green" variant="soft" size="2" style={{ textTransform: "capitalize" }}>
                {item.partOfSpeech}
              </Badge>
            </Box>
                ...
                {role === 'admin' && (
                  <AlertDialog.Root>
                    ...
                    <AlertDialog.Content maxWidth="450px">
                      <AlertDialog.Title>Delete this phrase?</AlertDialog.Title>
